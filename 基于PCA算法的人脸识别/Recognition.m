...
for i = 1 : Train_Number
    temp = Eigenfaces'*A(:,i); % Projection of centered images into facespace将每个样本投影到特征空间
...
ProjectedTestImage = Eigenfaces'*Difference; % Test image feature vector将待测样本投影到特征空间
